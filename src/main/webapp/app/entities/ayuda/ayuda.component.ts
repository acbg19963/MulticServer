...
export class AyudaComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Ayuda) {
        return item.id;
    }
    registerChangeInAyudas() {
        this.eventSubscriber = this.eventManager.subscribe('ayudaListModification', (response) => this.reset());
    }
