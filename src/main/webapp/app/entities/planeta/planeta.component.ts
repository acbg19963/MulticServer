...
export class PlanetaComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Planeta) {
        return item.id;
    }
    registerChangeInPlanetas() {
        this.eventSubscriber = this.eventManager.subscribe('planetaListModification', (response) => this.reset());
    }
