...
@Component({
    selector: 'jhi-universo',
    templateUrl: './universo.component.html'
})
export class UniversoComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Universo) {
        return item.id;
    }
    registerChangeInUniversos() {
        this.eventSubscriber = this.eventManager.subscribe('universoListModification', (response) => this.reset());
    }
