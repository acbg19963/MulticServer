...
export class EstudianteComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Estudiante) {
        return item.id;
    }
    registerChangeInEstudiantes() {
        this.eventSubscriber = this.eventManager.subscribe('estudianteListModification', (response) => this.reset());
    }
